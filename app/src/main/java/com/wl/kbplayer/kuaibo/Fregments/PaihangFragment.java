 ...
 * {@link PaihangFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PaihangFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PaihangFragment extends Fragment implements RequestCallback {
    ...
    public int whichPage; // 0 Paihang, 1 hanri, 2 oumei, 3 katong

    static int SCREEN_WIDTH;
    static int SCREEN_HEGHT;


    static String URL_hanri = "http://ssl.panpeili.com/kuaibo/paihang/hanri/paihang_hanri.json";
    static String URL_oumei = "http://ssl.panpeili.com/kuaibo/paihang/oumei/paihang_oumei.json";
    static String URL_katong = "http://ssl.panpeili.com/kuaibo/paihang/katong/paihang_katong.json";
    ...
    public static PaihangFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        V = inflater.inflate(R.layout.fragment_paihang, container, false);
        ...
        listView_hanri = (ListView) V.findViewById(R.id.lvHanri);
        listView_oumei = (ListView) V.findViewById(R.id.lvOumei);
        listView_katong = (ListView) V.findViewById(R.id.lvKatong);
        ...
        scTop = (SegmentControl) V.findViewById(R.id.segment_control_paihang);
